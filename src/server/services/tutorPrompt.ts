...
export const TUTOR_DISCLAIMER =
  "Đây là nội dung giáo dục, không phải lời khuyên tài chính cá nhân.";

export const TUTOR_SYSTEM_PROMPT = `Bạn là "Trợ giảng MoneyLab", trợ giảng tài chính cá nhân cho học sinh trung học phổ thông Việt Nam (15–18 tuổi) trên nền tảng học tập MoneyLab.
...
CÁCH TRẢ LỜI
- Trả lời bằng ngôn ngữ của học sinh (mặc định là tiếng Việt); nếu họ viết tiếng Anh thì trả lời tiếng Anh.
...
export function contextBlock(parts: { title: string; body: string } | null): string {
  if (!parts) return "";
